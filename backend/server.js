...
const treasuryRoutes = require('./routes/treasuries');
...
app.get('/health', (req, res) => {
  res.json({
    success: true,
    message: 'Treasury Management System API is running',
...
// Start server
app.listen(PORT, () => {
  console.log(`🚀 Treasury Management System API running on port ${PORT}`);
